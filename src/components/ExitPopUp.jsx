    ...
    return (
        <section className="w-screen h-screen bg-exit-pop-up fixed top-0 left-0 flex justify-center items-center">
            <div className="w-[50%] xl:w-[30%] 2xl:w-[25%] max-sm:w-[80%] xl:text-lg bg-[white] flex flex-col rounded-md">
                ...
                <div className="flex">
                    <button className="w-[50%] bg-modal-red text-white border border-black rounded-bl-md h-[3rem]">
                        Sair
                    </button>
                    <button className="w-[50%] border border-black rounded-br-md h-[3rem] px-[1rem]">
                        Continuar na conta
                    </button>
                </div>
            </div>
