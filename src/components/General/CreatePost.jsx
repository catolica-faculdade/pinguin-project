function CreatePost() {
    return (
        <section className="w-screen h-screen bg-exit-pop-up fixed top-0 left-0 flex justify-center items-center">
            <form className="bg-[#E9E9E9] flex flex-col items-center gap-4 rounded-lg w-[30vw] border">
                ...
                <textarea placeholder="Conte alguma coisa..." className="text-left p-[5px] resize-none bg-white rounded-sm border w-[80%]" rows="6" cols="40" required></textarea>
                <p className="bg-[#C795E3] w-full h-10 text-center border-y content-center">Adicione uma imagem (opcional)</p>
                <label htmlFor="post-image" className="h-min w-[80%] self-center rounded-sm border"><img className="w-full rounded-sm" src="../src/assets/images/createPostStandardImage.svg" alt="Selecione uma imagem" /></label>
